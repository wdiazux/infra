...
export KUBECONFIG="$PWD/terraform/talos/kubeconfig"
```
...
There are two separate kubeconfigs for different environments:

| Environment | Kubeconfig Path | Purpose |
|-------------|-----------------|---------|
| Talos (Kubernetes) | `terraform/talos/kubeconfig` | Primary K8s cluster |
| Traditional VMs | Generated per VM | SSH-based access |

The Talos kubeconfig is generated by Terraform and stored locally. It connects to the Talos node at 10.10.2.10.
