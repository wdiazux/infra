...
|------|-------------|------|---------|:--------:|
| <a name="input_arch_template_name"></a> [arch\_template\_name](#input\_arch\_template\_name) | Arch Linux Packer template name in Proxmox | `string` | `"arch-cloud-template-v1.0.0"` | no |
...
| <a name="input_debian_template_name"></a> [debian\_template\_name](#input\_debian\_template\_name) | Debian Packer template name in Proxmox | `string` | `"debian-13-cloud-template-v1.0.0"` | no |
...
| <a name="input_nixos_template_name"></a> [nixos\_template\_name](#input\_nixos\_template\_name) | NixOS Packer template name in Proxmox | `string` | `"nixos-cloud-template-v1.0.0"` | no |
| <a name="input_proxmox_node"></a> [proxmox\_node](#input\_proxmox\_node) | Proxmox node name where VMs will be created | `string` | `"pve"` | no |
| <a name="input_ubuntu_template_name"></a> [ubuntu\_template\_name](#input\_ubuntu\_template\_name) | Ubuntu Packer template name in Proxmox | `string` | `"ubuntu-2404-cloud-template-v1.0.0"` | no |
...
| <a name="input_windows_template_name"></a> [windows\_template\_name](#input\_windows\_template\_name) | Windows Packer template name in Proxmox | `string` | `"windows-11-cloud-template-v1.0.0"` | no |
