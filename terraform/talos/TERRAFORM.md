...
| <a name="provider_helm.template"></a> [helm.template](#provider\_helm.template) | 3.1.1 |
...
| [helm_release.weave_gitops](https://registry.terraform.io/providers/hashicorp/helm/latest/docs/resources/release) | resource |
...
| [kubernetes_service.weave_gitops_lb](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service) | resource |
...
| [null_resource.wait_for_postgresql](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="input_enable_weave_gitops"></a> [enable\_weave\_gitops](#input\_enable\_weave\_gitops) | Enable Weave GitOps web UI for FluxCD | `bool` | `true` | no |
...
| <a name="input_postgresql_version"></a> [postgresql\_version](#input\_postgresql\_version) | PostgreSQL Helm chart version (Bitnami) | `string` | `"18.2.0"` | no |
...
| <a name="input_weave_gitops_admin_user"></a> [weave\_gitops\_admin\_user](#input\_weave\_gitops\_admin\_user) | Weave GitOps admin username | `string` | `"admin"` | no |
| <a name="input_weave_gitops_ip"></a> [weave\_gitops\_ip](#input\_weave\_gitops\_ip) | LoadBalancer IP for Weave GitOps UI | `string` | `"10.10.2.16"` | no |
| <a name="input_weave_gitops_password_hash"></a> [weave\_gitops\_password\_hash](#input\_weave\_gitops\_password\_hash) | Weave GitOps admin password (bcrypt hash). Generate with: echo -n 'password' \| gitops get bcrypt-hash | `string` | `""` | no |
| <a name="input_weave_gitops_version"></a> [weave\_gitops\_version](#input\_weave\_gitops\_version) | Weave GitOps Helm chart version | `string` | `"4.0.36"` | no |
...
| <a name="output_forgejo_http_url"></a> [forgejo\_http\_url](#output\_forgejo\_http\_url) | Forgejo Git server HTTP URL (port 80) |
